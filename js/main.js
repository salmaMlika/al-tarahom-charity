...
$(document).ready(function($) {
  ...
  $(document).ready(function () {
    $('.owl-carousel').owlCarousel({
        items: 1,                 // Affiche une seule image à la fois
        loop: true,               // Boucle entre les slides
        autoplay: true,           // Défilement automatique
        autoplayTimeout: 5000,    // Intervalle de temps entre les slides (en ms)
        autoplayHoverPause: false, // Ne pas arrêter au survol
        dots: true,               // Affiche les points de navigation
        nav: true,                // Affiche les flèches de navigation
        rewind: true,             // Réinitialise la boucle une fois la dernière slide atteinte
    });
});
